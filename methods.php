...
if($_SERVER['REQUEST_METHOD'] == 'POST'){  // Checking if Server Method is GET or POST
    $email = $_POST['email'];
    $pass = $_POST['pass'];
    echo '<div class="alert alert-warning alert-dismissible fade show" role="alert"><strong>Success!</strong> Your email ' . $email . " and password " . $pass . ' has been submitted successfully.<button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button></div>';
}
?>
<div class="container mt-3">
<form action="/PHP-Tut/T-21/methods.php" method="post">
